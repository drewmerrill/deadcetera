...
function renderMetronomePage(el) {
    ...
    // Gold pedal nameplate — engraved with the band name (real guitar
    // pedals engrave the brand on the body). Pulled from localStorage so
    // it matches Band Configuration. Falls back to "GrooveLinx" if no
    // band name set yet.
