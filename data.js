...
const allSongs = [
    ...
    { title: "Boom Boom Boom (WSP)", band: "WSP" },
    ...
    { title: "All Along the Watchtower", band: "GD" },
    ...
    // Goose
    { title: "1000 Miles", band: "Goose" },
    { title: "All I Need", band: "Goose" },
    { title: "Arrow", band: "Goose" },
    { title: "Arcadia", band: "Goose" },
    { title: "Atlas Dogs", band: "Goose" },
    { title: "Borne", band: "Goose" },
    { title: "Butter Rum", band: "Goose" },
    { title: "Cannot Find My Way", band: "Goose" },
    { title: "Bring It On Home", band: "Goose" },
    { title: "Creatures", band: "Goose" },
    { title: "Crazy (Gnarls Barkley)", band: "Goose" },
    { title: "Deep Water", band: "Goose" },
    { title: "Doctor Robert", band: "Goose" },
    { title: "Dripfield", band: "Goose" },
    { title: "Eleanor Rigby", band: "Goose" },
    { title: "Elizabeth", band: "Goose" },
    { title: "Earthling or Alien?", band: "Goose" },
    { title: "Factory Fiction", band: "Goose" },
    { title: "Finn's", band: "Goose" },
    { title: "Flooring Eddie", band: "Goose" },
    { title: "Fly Around My Pretty Little Miss", band: "Goose" },
    { title: "Fog of War", band: "Goose" },
    { title: "Get Innocuous!", band: "Goose" },
    { title: "Genie", band: "Goose" },
    { title: "Gently Floating Home", band: "Goose" },
    { title: "Golden Rule", band: "Goose" },
    { title: "Halloween (Goose)", band: "Goose" },
    { title: "Hot Tea", band: "Goose" },
    { title: "Hungersite", band: "Goose" },
    { title: "I Go Blind", band: "Goose" },
    { title: "Jive Lee", band: "Goose" },
    { title: "Lead the Way", band: "Goose" },
    { title: "Madhuvan", band: "Goose" },
    { title: "Madeleine", band: "Goose" },
    { title: "Maze of Love", band: "Goose" },
    { title: "Meet Me in the Morning", band: "Goose" },
    { title: "Mind Control", band: "Goose" },
    { title: "Moon", band: "Goose" },
    { title: "Neon Pillar", band: "Goose" },
    { title: "Noyz Boyz", band: "Goose" },
    { title: "On the Roof", band: "Goose" },
    { title: "Pancakes for Dinner", band: "Goose" },
    { title: "Papaya", band: "Goose" },
    { title: "Peter and the Wolf", band: "Goose" },
    { title: "Polyester Morning", band: "Goose" },
    { title: "Red Bird", band: "Goose" },
    { title: "Rosewood Heart", band: "Goose" },
    { title: "Route 9", band: "Goose" },
    { title: "Sigma Oasis", band: "Goose" },
    { title: "Slow Ready", band: "Goose" },
    { title: "Spirit of the Dark Horse", band: "Goose" },
    { title: "Stampede", band: "Goose" },
    { title: "Stawberry Fields Forever", band: "Goose" },
    { title: "Summertime Blues", band: "Goose" },
    { title: "SYM-1", band: "Goose" },
    { title: "The Bob Lazar Story", band: "Goose" },
    { title: "The Empress of Organos", band: "Goose" },
    { title: "Tumble", band: "Goose" },
    { title: "TUSA", band: "Goose" },
    { title: "Undertone", band: "Goose" },
    { title: "Unfamiliar Ground", band: "Goose" },
    { title: "Vagabond", band: "Goose" },
    { title: "Valley of the Dogs", band: "Goose" },
    { title: "Vis a Vis", band: "Goose" },
    { title: "Wasted Away Again in Margaritaville", band: "Goose" },
    { title: "Windmill", band: "Goose" },
    { title: "Wings", band: "Goose" },

    // Dave Matthews Band
    { title: "#41", band: "DMB" },
    { title: "Alanis", band: "DMB" },
    { title: "American Baby", band: "DMB" },
    { title: "Ants Marching", band: "DMB" },
    { title: "Anyone Seen the Bridge", band: "DMB" },
    { title: "Bartender", band: "DMB" },
    { title: "Belly Belly Nice", band: "DMB" },
    { title: "Best of What's Around", band: "DMB" },
    { title: "Big Eyed Fish", band: "DMB" },
    { title: "Blue Water", band: "DMB" },
    { title: "Boom Boom Boom (DMB)", band: "DMB" },
    { title: "Broken Things", band: "DMB" },
    { title: "Busted Stuff", band: "DMB" },
    { title: "Butterfly", band: "DMB" },
    { title: "Can't Stop", band: "DMB" },
    { title: "Corn Bread", band: "DMB" },
    { title: "Crash into Me", band: "DMB" },
    { title: "Crush", band: "DMB" },
    { title: "Dancing Nancies", band: "DMB" },
    { title: "Digging a Ditch", band: "DMB" },
    { title: "Don't Drink the Water", band: "DMB" },
    { title: "Dream Girl", band: "DMB" },
    { title: "Drive In Drive Out", band: "DMB" },
    { title: "Dreaming Tree", band: "DMB" },
    { title: "Eh Hee", band: "DMB" },
    { title: "Everyday", band: "DMB" },
    { title: "Fool to Think", band: "DMB" },
    { title: "Funny the Way It Is", band: "DMB" },
    { title: "Grace Is Gone", band: "DMB" },
    { title: "Gravedigger", band: "DMB" },
    { title: "Grey Street", band: "DMB" },
    { title: "Grux", band: "DMB" },
    { title: "Halloween (DMB)", band: "DMB" },
    { title: "Hunger for the Great Light", band: "DMB" },
    { title: "I Did It", band: "DMB" },
    { title: "I'll Back You Up", band: "DMB" },
    { title: "Idea of You", band: "DMB" },
    { title: "In the Right Place", band: "DMB" },
    { title: "Jimi Thing", band: "DMB" },
    { title: "Louisiana Bayou", band: "DMB" },
    { title: "Lie in Our Graves", band: "DMB" },
    { title: "Little Thing", band: "DMB" },
    { title: "Long Black Veil", band: "DMB" },
    { title: "Lover Lay Down", band: "DMB" },
    { title: "Loving Wings", band: "DMB" },
    { title: "Mercy (DMB)", band: "DMB" },
    { title: "Minarets", band: "DMB" },
    { title: "Monkey Man", band: "DMB" },
    { title: "Moth", band: "DMB" },
    { title: "Mother Father", band: "DMB" },
    { title: "Nancies", band: "DMB" },
    { title: "Old Dirt Hill", band: "DMB" },
    { title: "One Sweet World", band: "DMB" },
    { title: "Pantala Naga Pampa", band: "DMB" },
    { title: "Pig", band: "DMB" },
    { title: "Proudest Monkey", band: "DMB" },
    { title: "Rapunzel", band: "DMB" },
    { title: "Raven", band: "DMB" },
    { title: "Rhyme & Reason", band: "DMB" },
    { title: "River and All Its Cousins", band: "DMB" },
    { title: "Rooftop", band: "DMB" },
    { title: "Satellite", band: "DMB" },
    { title: "Say Goodbye", band: "DMB" },
    { title: "Seek Up", band: "DMB" },
    { title: "Shake Me Like a Monkey", band: "DMB" },
    { title: "She", band: "DMB" },
    { title: "So Damn Lucky", band: "DMB" },
    { title: "So Much to Say", band: "DMB" },
    { title: "Song That Jane Likes", band: "DMB" },
    { title: "Space Between", band: "DMB" },
    { title: "Stay (Wasting Time)", band: "DMB" },
    { title: "Steady As We Go", band: "DMB" },
    { title: "Stone", band: "DMB" },
    { title: "Stolen Away on 55th & 3rd", band: "DMB" },
    { title: "Stress", band: "DMB" },
    { title: "Sweet Up and Down", band: "DMB" },
    { title: "The Last Stop", band: "DMB" },
    { title: "The Maker", band: "DMB" },
    { title: "The Song Before the Song", band: "DMB" },
    { title: "Too Much", band: "DMB" },
    { title: "Tripping Billies", band: "DMB" },
    { title: "True Reflections", band: "DMB" },
    { title: "Two Step", band: "DMB" },
    { title: "Typical Situation", band: "DMB" },
    { title: "Warehouse", band: "DMB" },
    { title: "What Would You Say", band: "DMB" },
    { title: "When the World Ends", band: "DMB" },
    { title: "Where Are You Going", band: "DMB" },
    { title: "Why I Am", band: "DMB" }
