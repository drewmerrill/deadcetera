...
_Last updated: 2026-05-14 18:00 EDT (build `20260514-174732`) — **Reality Audit #10 (Home Page Intelligence Hierarchy) shipped. Read-only architecture audit. No code change. Proposes 4-tier "One Primary Narrative" model + canonical `GLReadinessModel` + scope chips; phased P0/P1/P2 plan with explicit non-goals.**_
