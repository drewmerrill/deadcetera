...
**Convergence Initiatives:** C2 (`GLStore.RehearsalSession` ownership) **Phase 1 + Phase 2 COMPLETE** ✅ · C3 (chart contract) ✅ via Stab #05 · C4 (status badge) ✅ via Stab #04 · C6 (per-route lifecycle) ✅ via Stab #03 · C1 (player surface unification) ✅ via Stabs #06/#07/#08 · C5 (`GLBandFeedStore`) ⏸ pending
