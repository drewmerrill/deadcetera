...
_Updated: 2026-05-14 16:00 EDT (build `20260514-160056`) — **Contextual Confidence Pass shipped. Empty-state copy improvements on Band Feed, Best Shot, Harmony Lab, Band Room, Stage View + Prep-for-Gig "what next" cue. Lightweight; no structural change.**_
