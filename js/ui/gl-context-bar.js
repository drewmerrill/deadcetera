...
(function () {
  ...
  var PAGE_META = {
    ...
    songs:           { section: 'Music',  label: 'Songs',              icon: '🎵' },
    setlists:        { section: 'Music',  label: 'Setlists',           icon: '📋' },
    practice:        { section: 'Music',  label: 'Practice',           icon: '🎯' },
    rehearsal:       { section: 'Music',  label: 'Rehearsals',         icon: '📅' },
    'rehearsal-intel': { section: 'Music', label: 'Rehearsal Intelligence', icon: '📅' },
    ideas:           { section: 'Music',  label: 'Ideas Board',        icon: '💡' },
    ...
    bestshot:        { section: 'More',   label: 'Best Shot',          icon: '🏆' },
    social:          { section: 'More',   label: 'Social Media',       icon: '📣' },
    finances:        { section: 'More',   label: 'Finances',           icon: '💰' },
    equipment:       { section: 'More',   label: 'Equipment',          icon: '🎛️' },
    contacts:        { section: 'More',   label: 'Contacts',           icon: '👥' },
    notifications:   { section: 'More',   label: 'Notifications',      icon: '🔔' },
    admin:           { section: 'More',   label: 'Settings',           icon: '⚙️' },
    help:            { section: 'More',   label: 'Help',               icon: '❓' },
  };
