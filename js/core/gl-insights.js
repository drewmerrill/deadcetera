    ...
    if (types.indexOf('stability') !== -1) {
      ...
      if (severity === 'high') {
        ...
        plan.actionPlan = [
          ...
          'Slow way down. Get everyone talking through the arrangement before anyone plays a note',
          ...
          'If it falls apart again, don\u2019t push through \u2014 isolate exactly where it breaks and loop that until it\u2019s muscle memory',
          'This is the one holding the set back. Lock it in and everything else gets easier.'
        ];
        plan.estimatedTime = 20;
      } else {
        plan.recommendation = 'Came apart last time \u2014 let\u2019s get a clean run';
        plan.actionPlan = [
          'Last time through, this one came off the rails \u2014 here\u2019s how to clean it up:',
          'Make sure everyone\u2019s aligned on the arrangement before you start playing',
          ...
          'One clean run and you\u2019ll feel the difference.'
        ];
      ...
      plan.actionPlan = severity === 'high' ? [
        ...
        'Loop it at 60% until everyone\u2019s making the switch without thinking',
        ...
        'Ten minutes on this and the whole flow opens up.'
      ];
      ...
      plan.actionPlan = severity === 'high' ? [
        ...
        'Put the click on and bring the tempo down 10\u201315 BPM from the target',
        'Play the trouble section together with the click until everyone\u2019s locked',
        'Gradually bring the tempo up \u2014 don\u2019t rush it',
        'Run the full song with the click, then without \u2014 the pocket should hold',
        'When it grooves without the click, that\u2019s when it locks in.'
      ] : [
        ...
        'Then drop it and see if the feel stays \u2014 that\u2019s the real test',
        'Quick tighten \u2014 shouldn\u2019t take long.'
      ];
      plan.estimatedTime = severity === 'high' ? 15 : 10;
      ...
      plan.actionPlan = [
        'Last time through, something was off with the pitch \u2014 let\u2019s sort it out:',
        'Before anyone plays a note, make sure the whole band is aligned on the key',
        ...
        severity === 'high' ? 'This keeps coming up \u2014 get it locked and stop wasting rehearsal time on it.' : 'When everyone\u2019s in the same place, the whole song opens up.'
      ];
      ...
      plan.actionPlan = severity === 'high' ? [
        ...
        'Read through the lyrics together, out loud, no music \u2014 actually learn them',
        'Sing it vocals-only twice \u2014 feel where each line lands in the rhythm',
        'Then run it with the full band \u2014 no lyric sheets if you can help it',
        ...
        'Read the lyrics out loud together \u2014 no music, no pressure',
        'Sing it through once vocals-only \u2014 feel where the words land',
        'Then run it with the full band \u2014 should feel locked in',
        'Quick win \u2014 a few minutes and you\u2019re good.'
      ];
      ...
      plan.actionPlan = [
        severity === 'high'
          ? 'Last time through, there\u2019s a section that keeps tripping the band up \u2014 it\u2019s time to actually fix it:'
      ...
      plan.actionPlan = [
        severity === 'high'
          ? 'Last time through, a few things were off on this one \u2014 let\u2019s give it proper attention:'
          : 'Last time through, something felt off:',
        'Quick check-in with the band \u2014 what did everyone notice?',
        ...
        severity === 'high' ? 'This one needs the time. Put in the reps now and it pays off at the gig.' : 'One more clean run and you\u2019re solid.'
      ];
      plan.estimatedTime = severity === 'high' ? 12 : 8;
    }
