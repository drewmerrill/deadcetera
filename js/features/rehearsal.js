...
if (typeof glSpotlight !== 'undefined') {
    glSpotlight.register('rehearsal-plan-v3', [
        ...
        { target: function() { return document.querySelector('[onclick*="_rhAddBlock(\\\'section"]'); },
          prepare: function() { _rhEnsureAddBlockMenu(true); },
          text: 'A Section is a header that labels a phase of rehearsal. Example: add a "WARM-UP" section, then put a jam and cold starts underneath it. Add "SONG WORK," then put your songs underneath.' },
