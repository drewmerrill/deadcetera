...
// Register rehearsal walkthrough v5 — full workflow from setup to sharing
// position: 'above' forces info box above target so highlighted content stays visible
if (typeof glSpotlight !== 'undefined') {
    glSpotlight.register('rehearsal-plan-v3', [
        // Pre-step: how did this plan get here?
        { target: '#rhPlanCard', position: 'above',
          text: 'This plan was generated by picking a gig and a time budget. You can also build one from scratch by clearing this and using "+ Add Block." Either way, edit it to match how you actually want to run rehearsal.' },
        // Building the plan
        { target: '#rhAddBlockBtn', position: 'above',
          text: 'Tap here to add a block. A block is one agenda item — a song to work on, an exercise, a jam, band business, or a note to the group.' },
        { target: function() { return document.querySelector('[onclick*="_rhAddBlock(\\\'section"]') || document.querySelector('.rh-unit-row'); }, position: 'above',
          text: 'A Section is a header that labels a phase of rehearsal. Example: add a "WARM-UP" section, then put a jam and cold starts underneath it. Add "SONG WORK," then put your songs underneath. It keeps the plan readable.' },
        ...
        { target: function() { return document.querySelector('[onclick="_rhSaveSnapshotUI()"]'); }, position: 'above',
          text: 'Save Snapshot saves a copy of this plan. Use it before making big changes, or to save a plan you liked and want to reuse for a future rehearsal.' },
        ...
        // Sharing
        { target: '#rhSaveState', position: 'above',
