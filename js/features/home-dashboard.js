...
function _renderListeningCard(bundleType, title, subtitle) {
    ...
    return '<div class="app-card home-anim-cards" style="border-left:3px solid rgba(99,102,241,0.2)">'
        ...
        + '<button onclick="ListeningBundles.quickLaunch(\'' + bundleType + '\',\'spotify\')" style="display:flex;align-items:center;gap:4px;padding:6px 12px;border-radius:6px;cursor:pointer;font-size:0.72em;font-weight:600;border:1px solid rgba(30,215,96,0.15);background:none;color:rgba(30,215,96,0.6)">\u25B6 Quick Listen</button>'
